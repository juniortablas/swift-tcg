...
function Frame({
  ...
  return (
    <svg
      ...
      className={cn("mx-auto h-28 w-auto text-green-600", className)}
      role="img"
  ...
  return (
    <Frame {...props} title={props.title ?? "Trading card escaping a binder"}>
      <rect
        ...
        height="72"
        rx="10"
        className="fill-green-600/[0.08] stroke-green-600/30"
        strokeWidth="2"
      />
      <path
      ...
      <rect
        ...
        strokeWidth="2.5"
      />
      <circle cx="106" cy="42" r="12" className="fill-green-600/15" />
      <path
        d="M96 72h20M96 82h14"
        className="stroke-green-600/40"
        strokeWidth="3"
        strokeLinecap="round"
      />
    </Frame>
...
export function HeartEmptyIllustration(props: IllustrationProps) {
  return (
    <Frame {...props} title={props.title ?? "Empty wishlist"}>
      <circle cx="80" cy="60" r="44" className="fill-green-600/[0.07]" />
      <path
  ...
  return (
    <Frame {...props} title={props.title ?? "Coming soon"}>
      ...
      <rect
        ...
        strokeWidth="2.5"
      />
      <circle cx="80" cy="58" r="12" className="fill-green-600/15" />
      <path
  ...
  return (
    <Frame {...props} title={props.title ?? "Something went wrong"}>
      ...
      <path
        ...
        className="stroke-green-600/35"
        strokeWidth="3"
        strokeLinecap="round"
      />
      <circle cx="112" cy="40" r="14" className="fill-white stroke-green-600" strokeWidth="2.5" />
      <path

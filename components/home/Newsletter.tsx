  ...
  return (
    <section className="bg-white">
      <div className="mx-auto max-w-[1920px] px-4 sm:px-6 lg:px-8 xl:px-10">
        <div className="overflow-hidden rounded-[16px] border border-indigo-600/10 bg-[linear-gradient(135deg,#eef2ff_0%,#e0e7ff_45%,#ede9fe_100%)] px-4 py-5 sm:rounded-[24px] sm:px-9 sm:py-10 lg:px-12 lg:py-12">
          <div className="flex flex-col items-start justify-between gap-4 sm:gap-7 lg:flex-row lg:items-center lg:gap-12">
            <div className="flex max-w-lg items-start gap-3 sm:gap-4">
              <div
                aria-hidden="true"
                className="mt-0.5 flex size-9 shrink-0 items-center justify-center rounded-full bg-indigo-600/10 text-indigo-700 sm:size-11"
              >
            ...
            {phase === "success" ? (
              <p
                ...
                tabIndex={-1}
                role="status"
                className="text-sm font-medium text-indigo-700 outline-none"
              >
              ...
              >
                ...
                <input
                  ...
                  className="h-12 w-full rounded-full border border-black/10 bg-white px-5 text-sm text-black outline-none placeholder:text-black/35 focus:border-indigo-600/40 focus:ring-2 focus:ring-indigo-600/20 disabled:opacity-60"
                />
                <Button
                  type="submit"
                  disabled={pending}
                  aria-busy={pending}
                  className="h-12 shrink-0 rounded-full bg-indigo-600 px-7 text-sm font-semibold text-white shadow-[0_8px_20px_-10px_rgba(79,70,229,0.45)] transition-transform duration-200 hover:scale-[1.02] hover:bg-indigo-700 disabled:hover:scale-100"
                >
                  Subscribe
                </Button>
